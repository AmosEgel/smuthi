...
def taxsym_write_input_spheroid(vacuum_wavelength=None, layer_refractive_index=None, particle_refractive_index=None,
    ...
    f = open('smuthi/nfmds/data/InputAXSYM.dat', 'w')
    ...
    f.write('\n')
    f.write('Tmat\n')
    f.write("'smuthi/nfmds/data/" + filename + "'\n")
    f.write(' Variable:\n')
...
def taxsym_read_tmatrix(filename):
    ...
    info_file = open('smuthi/nfmds/data/Info' + filename, 'r')
    ...
    tmat_file = open('smuthi/nfmds/data/' + filename, 'r')

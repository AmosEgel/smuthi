...
setup(
    ...
    packages=['smuthi',
              'smuthi.fields',
              'smuthi.linearsystem',
              'smuthi.linearsystem.t_matrix',
              'smuthi.linearsystem.t_matrix.nfmds',
              'smuthi.linearsystem.particle_coupling',
              'smuthi.post_processing',
              'smuthi.utility'],
    cmdclass={'install': CustomInstallCommand},
    package_data={'smuthi.linear_system.t_matrix.nfmds': ['NFM-DS/*.txt', 'NFM-DS/TMATSOURCES/*', 'NFM-DS/TMATFILES/*',

...
dipole1 = init.DipoleSource(vacuum_wavelength=ld, dipole_moment=D1, position=rD1, contour=ctr,
                            azimuthal_angles=np.arange(0, 361, 1) * np.pi / 180)

dipole2 = init.DipoleSource(vacuum_wavelength=ld, dipole_moment=D2, position=rD2, contour=ctr,
                            azimuthal_angles=np.arange(0, 361, 1) * np.pi / 180)

dipole3 = init.DipoleSource(vacuum_wavelength=ld, dipole_moment=D3, position=rD3, contour=ctr,
                            azimuthal_angles=np.arange(0, 361, 1) * np.pi / 180)
